#ifndef CAFFE_SOFT_RANK_LOSS_LAYER_HPP_
#define CAFFE_SOFT_RANK_LOSS_LAYER_HPP_
...
class SoftRankLossLayer : public LossLayer<Dtype> {
 public:
  explicit SoftRankLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline int ExactNumBottomBlobs() const { return 3; }
  virtual inline const char* type() const { return "SoftRankLoss"; }
...
#endif  // CAFFE_SOFT_RANK_LOSS_LAYER_HPP_
