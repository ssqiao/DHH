...
// Caffe svd qss
template <typename Dtype>
int caffe_cpu_gesvd(const int M, const int N, Dtype* A, Dtype* S, Dtype *U, 
    Dtype *Vt);	
	
// Caffe Diag operation qss
template <typename Dtype>
void caffe_cpu_diag_op(const int M, const int N, const Dtype* A, Dtype* D, 
	const int op);	
	
// Caffe create a diagnal matrix via a K-D vector qss
template <typename Dtype>
void caffe_cpu_diag(const int M, const int N, const int K, const Dtype* x, Dtype* Y);
...
// Caffe Diag operation qss
template <typename Dtype>
void caffe_gpu_diag_op(const int M, const int N, const Dtype* A, Dtype* D, 
	const int op);	
	
// Caffe create a diagnal matrix via a K-D vector qss
template <typename Dtype>
void caffe_gpu_diag(const int M, const int N, const int K, const Dtype* x, Dtype* Y);
